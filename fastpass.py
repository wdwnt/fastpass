...
def entertainment_broadcasts():
    return _broadcasts('entertainment', BROADCAST_ENTERTAINMENT_CLIENT_ID, BROADCAST_ENTERTAINMENT_CLIENT_SECRET, BROADCAST_ENTERTAINMENT_REFRESH_TOKEN)
...
def entertainment_unlisted_videos():
    return _unlisted_videos('entertainment', BROADCAST_ENTERTAINMENT_CLIENT_ID, BROADCAST_ENTERTAINMENT_CLIENT_SECRET, BROADCAST_ENTERTAINMENT_REFRESH_TOKEN)
